...
import app.enlily.focus.apps.AppSelectionScreen
import app.enlily.focus.settings.DebugSettingsScreen
import app.enlily.focus.settings.FocusReminderEditorScreen
import app.enlily.focus.settings.FocusRemindersScreen
import app.enlily.focus.settings.GrayscaleSettingsScreen
import app.enlily.focus.settings.SettingsScreen
import app.enlily.focus.settings.BackupScreen
    ...
    Scaffold(
        ...
        NavHost(
            ...
            composable(
                ...
                val remindersViewModel: app.enlily.focus.settings.FocusRemindersViewModel = viewModel()
